...
export default function faq() {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
    ...
    <div className=" bg-[#05091a]/30 py-10 sm:py-32">
        <h1 className="text-4xl font-extrabold tracking-tight text-center text-white sm:text-5xl pb-10">Here's Some Stats About Us</h1>
